...
class Global(IContext, ICallable):
    ...
    def local_ip(self):
        return self.params['server']['servers'][self.params['server']['process'][0]['server']]['internet']

    def http_cdkey(self):
        return self.params['server']['http.cdkey']
    ...
    # only for sdk
    def game_list(self):
        return self.params['server']['game.list']

    def config_time(self):
        return self.params['update.time']

    def proto(self):
        return self.process_info.get('proto')
