...
add_game_config(2, 'builder.209.config', {
    'ratio': [
        [101, 5],
        [102, 5],
        [103, 5],
...
add_game_config(2, 'bonus.209.config',[176, 177, 178, 179, 180, 181, 182, 183])
...
add_game_config(2, 'boom.209.config',
    {
        551:{
            't':[5 * 600, 5 * 600],
            'l':60,
...
add_game_config(2, 'box.209.config',
    {
        #'box_id': [601, 602, 603],
...
#鸟券怪
add_game_config(2, 'coupon.209.config',
    {
        'box_id': [501],
...
#靶场券怪
add_game_config(2, 'target.209.config',
    {
        'box_id': [511],
...
add_game_config(2, 'bird_spacial.209.config',{
    'lst':{
			#1: ['h', 'b', 'h', 'b', 'h', 'a', 'c', 'a', 'b', 'h', 'e', 'a', 'b', 'a', 'd', 'b', 'f']
            1: ['a', 'b', 'e', 'a', 'b', 'f','i','e', 'a', 'e', 'a', 'b', 'h', 'e', 'f', 'a', 'b', 'e', 'i', 'a',  'b', 'f']
        },
    'group':{
            'a': [554, 552],
            'b': [551, 553],
...
add_game_config(2, 'bird_type_list.209.config',{
        'update':{
...
add_game_config(2, 'not_flush.209.config',['b', 'c', 'd', 'e', 'f', 'g', 'h', 'i'])
add_game_config(2, 'type_bird.209.config',{
...
add_game_config(2,  'flush.209.config',  [
...
add_game_config(2, 'fall.209.config', [
    {
        'id': 101, 
        'a': [[1, 0, 0, 1]], 
...
add_game_config(2, 'table.boss.209.config', {
...
add_game_config(2, 'world.boss.209.config', {
...
#机器人配置
add_game_config(2, 'aiInfo.209.config',
    {
        1:{
            'barrel_level':[5,9],
            'betMul':[500,600],
...
# 完成任务给予的活跃度
# 奖励
add_game_config(2, 'task.209.config', {
